...
void Init_SPI()
{
    AUXR1 |= 0X04;			               //将 SPI 调整到 P2.1 P2.2 P2.3  P2.4
    AUXR1 &= 0XF7;
 ...
 * 返回值 : 无
 **************************************************************************************/
uint8 OLED_WrByte(uint8 dat, uint8 mode)
{
 ...
 * 返回值 : 无
 ******************************************************************************/
void OLED_Fill(uint8 y,uint8 dat)
{
    uint8 x;
    for (; y < 8; y++)
    {
 ...
 * 返回值 : 无
 ******************************************************************************/
void OLED_Fill_Row(uint8 y, uint8 dat)
{
    uint8 x;
 ...
 * 返回值 : 无
 ******************************************************************************/
//void LCD_P16x16Ch(uint8 x, uint8 y, uint8 N, unsigned char code ch[])
//{
//    uint8 wm = 0;
...
//    for (wm = 0; wm < 16; wm++)
//    {
//        OLED_WrByte(ch[adder], OLED_WR_DAT);
//        adder += 1;
//    }
//    OLED_Set_Pos(x, y + 1);
//    for (wm = 0; wm < 16; wm++)
...
//void LCE_PLine(uint8 x, uint8 y) {
//    uint8 wm = 0;
//    unsigned int adder = 0;
//    OLED_Set_Pos(x, y);
//    for (wm = 0; wm < 128; wm++)
//    {
//        OLED_WrByte(line1x128[adder], OLED_WR_DAT);
//        adder += 1;
//    }
//}
